...
import {
  User,
} from './components/radh-user/model';
...
declare global {
  ...
  interface HTMLRadhChartElement extends Components.RadhChart, HTMLStencilElement {}
  var HTMLRadhChartElement: {
    prototype: HTMLRadhChartElement;
    new (): HTMLRadhChartElement;
  };
  ...
  interface HTMLElementTagNameMap {
    ...
    'radh-chart': HTMLRadhChartElement;
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'radh-chart': LocalJSX.RadhChart & JSXBase.HTMLAttributes<HTMLRadhChartElement>;
